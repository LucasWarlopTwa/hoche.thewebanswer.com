 ...
 */
final class Version20220125012937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lunch DROP dish_id, DROP dessert_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lunch ADD dish_id INT DEFAULT NULL, ADD dessert_id INT DEFAULT NULL');
