...
use App\Repository\LaitierRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: LaitierRepository::class)]
class Laitier
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToMany(targetEntity: Lunch::class, mappedBy: 'laitiers')]
    private $lunches;

    #[ORM\ManyToMany(targetEntity: Dinner::class, mappedBy: 'laitiers')]
    private $dinners;

    #[ORM\ManyToMany(targetEntity: Category::class, inversedBy: 'laitiers')]
    private $category;

    #[ORM\ManyToOne(targetEntity: DishType::class, inversedBy: 'laitiers')]
    private $type;
